    ...
    data(){
        ...
        return {
            ...
            addFormRules: {
                ...
                email: [
                    {required: true, message: '请输入邮箱', trigger: 'blur'}, {min: 6, max: 15, message: '邮箱的长度在6~20个字符之间', trigger: 'blur'},
                     {validator: checkEmail, trigger: 'blur'}
                ],
                mobile: [
                    {required: true, message: '请输入手机号', trigger: 'blur'}, {min: 3, max: 11, message: '手机号的长度在3~11个字符之间', trigger: 'blur'},
...
this.total = res.data.total
    ...
    //    修改用户信息并提交
       editUserInfo(){
           ...
           if (res.meta.status !== 200){
               return this.$message.error('更新修改用户信息失败')
           }
        //    关闭对话框
        ...
        this.getUserList()
        // 提示修改成功
        this.$message.success('更新修改用户信息成功')
           })
       },
    //    根据id删除对应的用户信息
